periodVal = 8
groupVal = 3
filePath = paste("~/Dropbox/Academics/Research/UCSC/redwood-high-frequency-trading-remote/config/20170831/",sep="")
jumpFile = paste(filePath,"jumps_period",periodVal,"_group",groupVal,".csv",sep="")
investorFile = paste(filePath,"investors_period",periodVal,"_group",groupVal,".csv",sep="")
